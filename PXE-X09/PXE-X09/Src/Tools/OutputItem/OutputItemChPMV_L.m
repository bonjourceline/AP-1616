...
@implementation OutputItemChPMV_L
...
- (void)setup{
    ...
    //[self.self.Btn_Mute setImage:[UIImage imageNamed:@"chs_output_mute_right_normal"] forState:UIControlStateNormal];
    [self.Btn_Mute mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self.Btn_Polar.mas_right).offset([Dimens GDimens:3]);
