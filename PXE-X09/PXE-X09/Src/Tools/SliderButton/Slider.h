...
//音量条类型
typedef NS_ENUM(NSUInteger, SliderStyle) {
    Slider_LINE_ONLY = 1,  //只有圆形线
    Slider_LINE_PARK = 2,  //只有圆形线，线是分段的，像时钟那样
    Slider_LINE_IMAGE = 3, //有线和图片
    Slider_LINE_PARK_IMAGE = 4, //有圆形线，线是分段的，像时钟那样和图片
    Slider_TLINE_IMAGE = 5, //有线和图片
    Slider_IMAGE = 6, //图片
};
...
@property (nonatomic) SliderStyle SBStyle; //控件样式,默
