...
//代理协议
@protocol QIZLikeTableViewControllerDelegate <NSObject>
@optional
-(void)loadDialogZLike:(int)type;
@end


@interface QIZLikeTableViewController : UIViewController
...
@property (nonatomic, weak) id<QIZLikeTableViewControllerDelegate> delegate;
