//
//  QIZCollectionTableViewController.h
//  ReNetTuning
//
...
//代理协议
@protocol QIZCollectionTableViewControllerDelegate <NSObject>
@optional
-(void)loadDialogCollection:(int)type;
@end


@interface QIZCollectionTableViewController : UIViewController
...
@property (nonatomic, weak) id<QIZCollectionTableViewControllerDelegate> delegate;
