//
//  QIZAllEffectTableViewController.h
//  ReNetTuning
//
...
//代理协议
@protocol QIZAllEffectTableViewControllerDelegate <NSObject>
@optional
-(void)loadDialogAllEFFect:(int)type;
@end



@interface QIZAllEffectTableViewController : UIViewController
...
@property (nonatomic, weak) id<QIZAllEffectTableViewControllerDelegate> delegate;
