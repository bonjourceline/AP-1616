//
//  QIZCollectionTableViewController.m
//  ReNetTuning
//
...
@interface QIZCollectionTableViewController ()<LocalEffectTableViewCellDelegate,UITableViewDataSource,UITableViewDelegate,UIDocumentInteractionControllerDelegate,UIAlertViewDelegate>
{
...
@implementation QIZCollectionTableViewController
...
//        LocalEffectTableViewCell *cell = [self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:i inSection:0]];
    ...
    for (SEFFFile *effData in copyArray) {
        if ([effData.file_favorite isEqualToString:@"0"]) {
