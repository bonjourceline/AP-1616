...
- (void)setup{
    ...
    SBHeight = WIND_Height - BtnHeight*5;
    ...
    [self.Btn_Reset setImage:[[UIImage imageNamed:@"eq_resetg_normal"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
...
//    [self.SB_Gain setMaximumTrackImage:[UIImage imageNamed:@"mhs_progress_normal"] forState:UIControlStateNormal];
//    [self.SB_Gain setMinimumTrackImage:[UIImage imageNamed:@"mhs_progress_press"] forState:UIControlStateNormal];
    [self.SB_Gain setThumbImage:[UIImage imageNamed:@"thumb_normal"] forState:UIControlStateNormal];
//    [self.SB_Gain setThumbImage:[UIImage imageNamed:@"chs_thumb_press"] forState:UIControlStateHighlighted];
...
- (void)setStateColor:(int)State{
    switch (State) {
        case 1:
            ...
            break;
        case 2:
//            [self.Lab_ID setTextColor:SetColor(UI_Channel_BtnListText_Normal)];
