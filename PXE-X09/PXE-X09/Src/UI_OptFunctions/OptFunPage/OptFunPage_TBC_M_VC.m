...
@interface OptFunPage_TBC_M_VC ()

@end

@implementation OptFunPage_TBC_M_VC
...
- (void)tabBarController:(UITabBarController *)tabBarController didSelectViewController:(UIViewController *)viewController{
    ...
    }else if([tbselect isEqual:_mTabBarC.mXOverOutputFRS]){
        [_mTabBarC.mXOverOutputFRS FlashPageUI];
    }
}
