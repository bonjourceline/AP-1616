...
#import "OutputItemChPMV_L.h"
#import "OutputItemChPMV_R.h"

@interface XOverOutputFRSViewController : UIViewController
...
@property (strong, nonatomic) UIImageView *IV_CarType;
//弹出对话框调频率
...
//弹出对话框延时
@property (strong, nonatomic) ASValueTrackingSlider *sliderVol;
...
//Output
@property (strong, nonatomic) OutputItemChPMV_L *OutItemL_0;
@property (strong, nonatomic) OutputItemChPMV_R *OutItemR_1;
@property (strong, nonatomic) OutputItemChPMV_L *OutItemL_2;
@property (strong, nonatomic) OutputItemChPMV_R *OutItemR_3;
@property (strong, nonatomic) OutputItemChPMV_L *OutItemL_4;
@property (strong, nonatomic) OutputItemChPMV_R *OutItemR_5;
