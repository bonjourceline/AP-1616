...
- (void)initInputSourceView{
    ...
    [self.Btn_InputSource initViewBroder:3
                         withBorderWidth:0
                         withNormalColor:UI_DelayBtn_NormalIN
                          withPressColor:UI_DelayBtn_PressIN
                   withBorderNormalColor:UI_SystemBtnColorNormal
    ...
    [self.Btn_InputSource mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.Btn_MasterEncrypt.mas_centerY).offset([Dimens GDimens:0]);
        make.left.equalTo(self.view.mas_left).offset([Dimens GDimens:MasterMarginSide-5]);
        make.size.mas_equalTo(CGSizeMake([Dimens GDimens:MasterBtn_Width], [Dimens GDimens:MasterBtn_Height]));
    }];
    ...
    [self.Lab_InputSource mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(self.Btn_InputSource.mas_top).offset(-[Dimens GDimens:5]);
        make.centerX.equalTo(self.Btn_InputSource.mas_centerX).offset([Dimens GDimens:0]);
        make.size.mas_equalTo(CGSizeMake([Dimens GDimens:MasterBtn_Width], [Dimens GDimens:MasterBtn_Height]));
    }];
    self.Lab_InputSource.hidden = false;
...
- (void)initMasterMixerInputSourceView{
    ...
    [self.Btn_MixerInputSource initViewBroder:3
                              withBorderWidth:0
                              withNormalColor:UI_DelayBtn_NormalIN
                               withPressColor:UI_DelayBtn_PressIN
                        withBorderNormalColor:UI_SystemBtnColorNormal
    ...
    [self.Btn_MixerInputSource mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.Btn_InputSource.mas_top);
        make.right.equalTo(self.view.mas_right).offset(-[Dimens GDimens:MasterMarginSide-5]);
        make.size.mas_equalTo(CGSizeMake([Dimens GDimens:MasterBtn_Width], [Dimens GDimens:MasterBtn_Height]));
    }];
...
//    UIImageView *imageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0,[Dimens GDimens:MasterVolume_SB_Size], [Dimens GDimens:MasterVolume_SB_Size])];
//    [imageView setImage:[UIImage imageNamed:@"master_vol_indicator"]];
//    [self.view addSubview:imageView];
    ...
    [self.SB_MasterVolume mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.mToolbar.mas_bottom).offset([Dimens GDimens:MasterBtn_Height]+30);
...
//        make.centerX.equalTo(self.view.mas_centerX).offset(0);
//        make.size.mas_equalTo(CGSizeMake([Dimens GDimens:MasterVolume_SB_Size+30], [Dimens GDimens:MasterVolume_SB_Size+30]));
//    }];
    UILabel *zeroLabel=[[UILabel alloc]initWithFrame:CGRectMake(0, 0, 20, 20)];
    zeroLabel.text=@"0";
    zeroLabel.textColor=SetColor(UI_SystemBtnColorNormal);
...
//        make.centerY.equalTo(self.SB_MasterVolume.mas_centerY).offset([Dimens GDimens:70]);
//        make.centerX.equalTo(self.SB_MasterVolume.mas_centerX).offset([Dimens GDimens:-100]);
//        make.size.mas_equalTo(CGSizeMake(30, 20));
//    }];
    UILabel *halfLabel=[[UILabel alloc]initWithFrame:CGRectMake(0, 0, 20, 20)];
    halfLabel.text=@"33";
    halfLabel.textColor=SetColor(UI_SystemBtnColorNormal);
...
//        make.centerY.equalTo(self.SB_MasterVolume.mas_centerY).offset([Dimens GDimens:-125]);
//        make.centerX.equalTo(self.SB_MasterVolume.mas_centerX);
//        make.size.mas_equalTo(CGSizeMake(30, 20));
//    }];
    UILabel *fullLab=[[UILabel alloc]initWithFrame:CGRectMake(0, 0, 20, 20)];
    fullLab.text=@"66";
    fullLab.textColor=SetColor(UI_SystemBtnColorNormal);
    fullLab.textAlignment=NSTextAlignmentCenter;
//    [self.view addSubview:fullLab];
//    [fullLab mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.centerY.equalTo(zeroLabel.mas_centerY);
//        make.centerX.equalTo(self.SB_MasterVolume.mas_centerX).offset([Dimens GDimens:100]);
//        make.size.mas_equalTo(CGSizeMake(30, 20));
//    }];
    ...
    [self.Lab_MasterVolume mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.SB_MasterVolume.mas_centerY).offset([Dimens GDimens:0]);
        make.centerX.equalTo(self.SB_MasterVolume.mas_centerX).offset([Dimens GDimens:0]);
    ...
    [self.Lab_MasterVolumeText mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(self.SB_MasterVolume.mas_top).offset([Dimens GDimens:-10]);
        make.centerX.equalTo(self.view.mas_centerX).offset([Dimens GDimens:0]);
    ...
    [self.Btn_MasterMute initViewBroder:3
                        withBorderWidth:0
                        withNormalColor:UI_DelayBtn_NormalIN
    ...
    [self.Btn_MasterMute mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(self.SB_MasterVolume.mas_bottom).offset([Dimens GDimens:-20]);
        make.centerX.equalTo(self.view.mas_centerX).offset([Dimens GDimens:130]);
        make.size.mas_equalTo(CGSizeMake([Dimens GDimens:MasterBtn_Width], [Dimens GDimens:MasterBtn_Height]));
    }];
...
//音量设置
-(void)MasterVolumeSBChange:(VolumeCircleIMLine *)sender{
...
- (void)initSEFFUserGroup{
    ...
    self.Lab_SEFFText = [[UILabel alloc]init];
    [self.view addSubview:self.Lab_SEFFText];
    //[self.Lab_SEFFText setBackgroundColor:[UIColor redColor]];
    [self.Lab_SEFFText setBackgroundColor:[UIColor clearColor]];
    [self.Lab_SEFFText setTextColor:SetColor(UI_Master_VolumeTextColor)];
    self.Lab_SEFFText.text = [LANG DPLocalizedString:@"L_Master_PresetOpt"];
    self.Lab_SEFFText.font=[UIFont systemFontOfSize:18];
    self.Lab_SEFFText.adjustsFontSizeToFitWidth = true;
    self.Lab_SEFFText.textAlignment = NSTextAlignmentCenter;
    [self.Lab_SEFFText mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.Btn_MasterEncrypt.mas_bottom).offset([Dimens GDimens:30]);
        make.centerX.equalTo(self.view.mas_centerX);
        //        make.size.mas_equalTo(CGSizeMake([Dimens GDimens:150], [Dimens GDimens:MasterBtn_Height]));
    }];
    UIView *line1=[[UIView alloc]init];
    [self.view addSubview:line1];
    line1.backgroundColor=[UIColor whiteColor];
    [line1 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.Lab_SEFFText.mas_centerY);
        make.left.equalTo(self.view.mas_left).offset([Dimens GDimens:MasterMarginSide-10]);
        make.right.equalTo(self.Lab_SEFFText.mas_left).offset([Dimens GDimens:-5]);
    ...
    [line2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.Lab_SEFFText.mas_centerY);
        make.right.equalTo(self.view.mas_right).offset([Dimens GDimens:-MasterMarginSide+10]);
        make.left.equalTo(self.Lab_SEFFText.mas_right).offset([Dimens GDimens:5]);
        make.height.mas_offset(1);
    }];
    
    self.Btn_SEFF1 = [[NormalButton alloc]init];
    [self.Btn_SEFF1 setTag:1];
    [self.view addSubview:self.Btn_SEFF1];
    [self.Btn_SEFF1 initViewBroder:3
                   withBorderWidth:0
                   withNormalColor:UI_DelayBtn_NormalIN
                    withPressColor:UI_DelayBtn_PressIN
             withBorderNormalColor:UI_Master_UserGroup_Btn_Normal
              withBorderPressColor:UI_Master_UserGroup_Btn_Press
               withTextNormalColor:UI_Master_UserGroup_BtnText_Normal
                withTextPressColor:UI_Master_UserGroup_BtnText_Press
                          withType:5];
    [self.Btn_SEFF1 addTarget:self action:@selector(Btn_SEFF_Click:) forControlEvents:UIControlEventTouchUpInside];
    [self.Btn_SEFF1 setTitle:[LANG DPLocalizedString:@"L_Master_Preset1"] forState:UIControlStateNormal] ;
    self.Btn_SEFF1.titleLabel.adjustsFontSizeToFitWidth = true;
    self.Btn_SEFF1.titleLabel.font = [UIFont systemFontOfSize:13];
    [self.Btn_SEFF1 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.Lab_SEFFText.mas_bottom).offset([Dimens GDimens:20]);
        make.left.equalTo(self.view.mas_left).offset([Dimens GDimens:MasterMarginSide]);
        make.size.mas_equalTo(CGSizeMake([Dimens GDimens:UserPresetWidth], [Dimens GDimens:UserPresetHeight]));
    }];
    
    self.Btn_SEFF2 = [[NormalButton alloc]init];
    [self.Btn_SEFF2 setTag:2];
    [self.view addSubview:self.Btn_SEFF2];
    [self.Btn_SEFF2 initViewBroder:3
                   withBorderWidth:0
                   withNormalColor:UI_DelayBtn_NormalIN
                    withPressColor:UI_DelayBtn_PressIN
             withBorderNormalColor:UI_Master_UserGroup_Btn_Normal
              withBorderPressColor:UI_Master_UserGroup_Btn_Press
               withTextNormalColor:UI_Master_UserGroup_BtnText_Normal
                withTextPressColor:UI_Master_UserGroup_BtnText_Press
                          withType:5];
    [self.Btn_SEFF2 addTarget:self action:@selector(Btn_SEFF_Click:) forControlEvents:UIControlEventTouchUpInside];
    [self.Btn_SEFF2 setTitle:[LANG DPLocalizedString:@"L_Master_Preset2"] forState:UIControlStateNormal] ;
    self.Btn_SEFF2.titleLabel.adjustsFontSizeToFitWidth = true;
    self.Btn_SEFF2.titleLabel.font = [UIFont systemFontOfSize:13];
    [self.Btn_SEFF2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.Btn_SEFF1.mas_centerY).offset([Dimens GDimens:0]);
        make.centerX.equalTo(self.view.mas_centerX).offset([Dimens GDimens:0]);
        make.size.mas_equalTo(CGSizeMake([Dimens GDimens:UserPresetWidth], [Dimens GDimens:UserPresetHeight]));
    }];
    
    self.Btn_SEFF3 = [[NormalButton alloc]init];
    [self.Btn_SEFF3 setTag:3];
    [self.view addSubview:self.Btn_SEFF3];
    [self.Btn_SEFF3 initViewBroder:3
                   withBorderWidth:0
                   withNormalColor:UI_DelayBtn_NormalIN
                    withPressColor:UI_DelayBtn_PressIN
             withBorderNormalColor:UI_Master_UserGroup_Btn_Normal
              withBorderPressColor:UI_Master_UserGroup_Btn_Press
               withTextNormalColor:UI_Master_UserGroup_BtnText_Normal
                withTextPressColor:UI_Master_UserGroup_BtnText_Press
                          withType:5];
    [self.Btn_SEFF3 addTarget:self action:@selector(Btn_SEFF_Click:) forControlEvents:UIControlEventTouchUpInside];
    [self.Btn_SEFF3 setTitle:[LANG DPLocalizedString:@"L_Master_Preset3"] forState:UIControlStateNormal] ;
    self.Btn_SEFF3.titleLabel.adjustsFontSizeToFitWidth = true;
    self.Btn_SEFF3.titleLabel.font = [UIFont systemFontOfSize:13];
    [self.Btn_SEFF3 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.Btn_SEFF1.mas_centerY).offset([Dimens GDimens:0]);
        make.right.equalTo(self.view.mas_right).offset(-[Dimens GDimens:MasterMarginSide]);
        make.size.mas_equalTo(CGSizeMake([Dimens GDimens:UserPresetWidth], [Dimens GDimens:UserPresetHeight]));
    }];
    
    self.Btn_SEFF4 = [[NormalButton alloc]init];
    [self.Btn_SEFF4 setTag:4];
    [self.view addSubview:self.Btn_SEFF4];
    [self.Btn_SEFF4 initViewBroder:3
                   withBorderWidth:0
                   withNormalColor:UI_DelayBtn_NormalIN
                    withPressColor:UI_DelayBtn_PressIN
             withBorderNormalColor:UI_Master_UserGroup_Btn_Normal
              withBorderPressColor:UI_Master_UserGroup_Btn_Press
               withTextNormalColor:UI_Master_UserGroup_BtnText_Normal
                withTextPressColor:UI_Master_UserGroup_BtnText_Press
                          withType:5];
    [self.Btn_SEFF4 addTarget:self action:@selector(Btn_SEFF_Click:) forControlEvents:UIControlEventTouchUpInside];
    [self.Btn_SEFF4 setTitle:[LANG DPLocalizedString:@"L_Master_Preset3"] forState:UIControlStateNormal] ;
    self.Btn_SEFF4.titleLabel.adjustsFontSizeToFitWidth = true;
    self.Btn_SEFF4.titleLabel.font = [UIFont systemFontOfSize:13];
    [self.Btn_SEFF4 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.Btn_SEFF1.mas_bottom).offset([Dimens GDimens:UserPresetMarginTopL1]);
        make.left.equalTo(self.view.mas_left).offset([Dimens GDimens:MasterMarginSide]);
        make.size.mas_equalTo(CGSizeMake([Dimens GDimens:UserPresetWidth], [Dimens GDimens:UserPresetHeight]));
    }];
    
    self.Btn_SEFF5 = [[NormalButton alloc]init];
    [self.Btn_SEFF5 setTag:5];
    [self.view addSubview:self.Btn_SEFF5];
    [self.Btn_SEFF5 initViewBroder:3
                   withBorderWidth:0
                   withNormalColor:UI_DelayBtn_NormalIN
                    withPressColor:UI_DelayBtn_PressIN
             withBorderNormalColor:UI_Master_UserGroup_Btn_Normal
              withBorderPressColor:UI_Master_UserGroup_Btn_Press
               withTextNormalColor:UI_Master_UserGroup_BtnText_Normal
                withTextPressColor:UI_Master_UserGroup_BtnText_Press
                          withType:5];
    [self.Btn_SEFF5 addTarget:self action:@selector(Btn_SEFF_Click:) forControlEvents:UIControlEventTouchUpInside];
    [self.Btn_SEFF5 setTitle:[LANG DPLocalizedString:@"L_Master_Preset5"] forState:UIControlStateNormal] ;
    self.Btn_SEFF5.titleLabel.adjustsFontSizeToFitWidth = true;
    self.Btn_SEFF5.titleLabel.font = [UIFont systemFontOfSize:13];
    [self.Btn_SEFF5 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.Btn_SEFF4.mas_centerY).offset([Dimens GDimens:0]);
        make.centerX.equalTo(self.view.mas_centerX).offset([Dimens GDimens:0]);
        make.size.mas_equalTo(CGSizeMake([Dimens GDimens:UserPresetWidth], [Dimens GDimens:UserPresetHeight]));
    }];
    
    self.Btn_SEFF6 = [[NormalButton alloc]init];
    [self.Btn_SEFF6 setTag:6];
    [self.view addSubview:self.Btn_SEFF6];
    [self.Btn_SEFF6 initViewBroder:3
                   withBorderWidth:0
                   withNormalColor:UI_DelayBtn_NormalIN
                    withPressColor:UI_DelayBtn_PressIN
             withBorderNormalColor:UI_Master_UserGroup_Btn_Normal
              withBorderPressColor:UI_Master_UserGroup_Btn_Press
               withTextNormalColor:UI_Master_UserGroup_BtnText_Normal
                withTextPressColor:UI_Master_UserGroup_BtnText_Press
                          withType:5];
    [self.Btn_SEFF6 addTarget:self action:@selector(Btn_SEFF_Click:) forControlEvents:UIControlEventTouchUpInside];
    [self.Btn_SEFF6 setTitle:[LANG DPLocalizedString:@"L_Master_Preset6"] forState:UIControlStateNormal] ;
    self.Btn_SEFF6.titleLabel.adjustsFontSizeToFitWidth = true;
    self.Btn_SEFF6.titleLabel.font = [UIFont systemFontOfSize:13];
    [self.Btn_SEFF6 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.Btn_SEFF4.mas_centerY).offset([Dimens GDimens:0]);
        make.right.equalTo(self.view.mas_right).offset(-[Dimens GDimens:MasterMarginSide]);
        make.size.mas_equalTo(CGSizeMake([Dimens GDimens:UserPresetWidth], [Dimens GDimens:UserPresetHeight]));
    }];
    ...
    if(BOOL_USEG){
        for(int i=1;i<=MAX_USE_GROUP;i++){
            ...
            if ([groupName isEqualToString:@""] || '\0' == [groupName characterAtIndex:0]) {
                //根据tag查找
                NormalButton *find_btn = (NormalButton *)[self.view viewWithTag:i];
                [find_btn setTitle:[NSString stringWithFormat:@"%@%d",[LANG DPLocalizedString:@"L_Master_Preset"],(i)] forState:UIControlStateNormal] ;
            }else {
                NormalButton *find_btn = (NormalButton *)[self.view viewWithTag:i];
