...
-(void)initView{
    ...
    [self.selectBtn setImage:[UIImage imageNamed:@"Selected_normal"] forState:UIControlStateNormal];
    [self.selectBtn addTarget:self action:@selector(selectSource:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [lineView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(self.selectBtn.mas_right);
...
-(void)selectSource:(UIButton *)sender{
    ...
    self.selectBlock(isSelected,self.tag);
}
-(void)flashSelect:(BOOL)isChoose{
    if (isChoose) {
        isSelected=YES;
        [self.selectBtn setImage:[UIImage imageNamed:@"Selected_press"] forState:UIControlStateNormal];
    }else{
        isSelected=NO;
        [self.selectBtn setImage:[UIImage imageNamed:@"Selected_normal"] forState:UIControlStateNormal];
    }
