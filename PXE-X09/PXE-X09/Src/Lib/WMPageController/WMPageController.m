...
- (void)setup {
    ...
    _titleColorSelected = SetColor(UI_SEFFF_Title_Press);//WMTitleColorSelected;
    _titleSizeNormal    = WMTitleSizeNormal;
    _titleColorNormal   = SetColor(UI_SEFFF_Title_Normal);//WMTitleColorNormal;
    
    _menuBGColor   = SetColor(UI_SystemBgColor);//WMMenuBGColor;
